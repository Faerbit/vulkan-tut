...
private:
    ...
    void initWindow() {
        glfwSetErrorCallback(&TriangleApp::glfwError);
        if (!glfwInit()) {
        ...
        glfwSetKeyCallback(window, TriangleApp::keyCallback);
    }
    ...
    void createCommandBuffers() {
        ...
        for (size_t i = 0; i<commandBuffers.size(); i++) {
            ...
            vkBeginCommandBuffer(commandBuffers.at(i), &beginInfo);
            ...
            vkCmdBeginRenderPass(commandBuffers.at(i), &renderPassInfo,
                    VK_SUBPASS_CONTENTS_INLINE);
            vkCmdBindPipeline(commandBuffers.at(i),
    ...
    QueueFamilyIndices findQueueFamilies(VkPhysicalDevice device) {
        ...
        for (unsigned int i = 0; i<queueFamilies.size(); ++i) {
            VkQueueFamilyProperties& queueFamily = queueFamilies.at(i);
    ...
    VkPresentModeKHR chooseSwapPresentMode(
        ...
        if (fifo_avail) {
            ...
            throw std::runtime_error("PRESENT_MODE_FIFO not available.");
        }
    }
